...
// Cấu trúc 110 câu đã FIX triệt để toàn bộ góp ý phát âm, độ tuổi nhân vật & tách đổi giọng
export const MASTER_PERFECT_PLAN = [
  ...
  },
  {
    ...
    segments: [
      ...
      { text: "Looking pretty sharp today, champ.", voice: "am_michael", speed: 1.0 } // Giọng thanh niên trẻ
    ]
  },
  {
    lineNum: 3,
  ...
  },
  {
    lineNum: 5,
    segments: [
      // Sửa lỗi "blurt out": viết rõ phonetics hoặc nhấn mạnh "blurt out"
  ...
  // 011 - 019: Scene 2 - Bữa sáng gia đình (Mẹ 50 tuổi af_bella, Bố 52 tuổi am_eric, Con trai 24 tuổi am_michael)
  {
    lineNum: 11,
    segments: [
      ...
      { text: "How do the homemade pancakes look, boys?", voice: "af_bella", speed: 0.98 } // Mẹ trung niên
    ]
  },
  {
    lineNum: 12,
    segments: [
      ...
      { text: "Honey, your cooking is always wonderful.", voice: "am_eric", speed: 0.95 } // Bố đứng tuổi
    ]
  },
  {
    lineNum: 13,
  ...
  },
  {
    lineNum: 14,
    segments: [
      { text: "Honestly, Susan, this looks like radioactive fallout from a nuclear disaster, and I would literally rather eat mulch from the front yard than swallow this bitter charcoal!", voice: "am_eric", speed: 1.1 } // Bố đứng tuổi
    ]
  },
  {
    lineNum: 15,
  ...
  },
  {
    lineNum: 18,
    segments: [
      { text: "I’ve hated your cooking since I was six years old, mom, and I only pretend to love it so you don't assign me extra weekend chores!", voice: "am_michael", speed: 1.15 } // Con trai trẻ
    ]
  },
  {
    lineNum: 19,
  ...
  // 020 - 025: Scene 3 - Thang máy & Bà Higgins (Bà lão 60+ tuổi af_sarah 0.92x)
  {
    lineNum: 20,
    segments: [
  ...
  },
  {
    ...
    segments: [
      ...
      { text: "Do you like my new haircut, dear? Don't you think it makes me look ten years younger?", voice: "af_sarah", speed: 0.92 } // Bà lão 60 tuổi
    ]
  },
  {
    lineNum: 23,
  ...
  },
  {
    lineNum: 24,
    segments: [
      { text: "You look like a wet poodle that got stuck in an industrial leaf blower, and it easily adds nine and a half years to your face!", voice: "am_michael", speed: 1.15 } // Con trai trẻ
    ]
  },
  {
    lineNum: 25,
  ...
  },
  {
    ...
    segments: [
      ...
      { text: "I have four dollars and seventeen cents in my checking account, I just emotionally destroyed my entire family, and I am in a state of profound existential dread.", voice: "am_michael", speed: 1.08 } // Con trai trẻ
    ]
  },
  {
    lineNum: 30,
  ...
  },
  {
    ...
    segments: [
      ...
      { text: "Brilliant strategic vision, sir!", voice: "am_michael", speed: 1.0 }
    ]
  },
  {
    lineNum: 37,
  ...
  },
  {
    lineNum: 38,
    segments: [
      { text: "With all due respect, I've just been nodding along so you wouldn't feel awkward, but you haven't said a single coherent sentence for the past forty-five minutes.", voice: "am_michael", speed: 0.98 } // Nhân viên trẻ bật sếp
    ]
  },
  {
    lineNum: 39,
    segments: [
      { text: "This roadmap is so staggeringly dumb that my golden retriever walking across a keyboard could produce a better business model.", voice: "am_michael", speed: 0.98 }
    ]
  },
  {
    lineNum: 40,
  ...
  },
  {
    ...
    segments: [
      ...
      // FIX ĐỔI GIỌNG: Nhân viên trẻ am_michael hỏi xin về sớm
      { text: "Hey boss, can I head out early today?", voice: "am_michael", speed: 1.05 }
    ]
  },
  {
    lineNum: 45,
  ...
  },
  {
    ...
    segments: [
      ...
      // FIX ĐỔI GIỌNG: Nhân viên trẻ am_michael quát sếp không muốn nhìn mặt
      { text: "No, I'm just sick and tired of looking at your face, and I want to go home and lie in bed watching YouTube videos!", voice: "am_michael", speed: 1.18 }
    ]
  },
  ...
  },
  {
    ...
    segments: [
      ...
      // FIX NĂNG LƯỢNG NỮ MC: Đổi sang af_heart hoặc af_bella tốc độ 1.08x để âm vang và kinh ngạc rõ tiếng
      { text: "Wait, are you serious about those economic forecasts?", voice: "af_bella", speed: 1.08 }
    ]
  },
  {
    lineNum: 53,
  ...
  },
  {
    lineNum: 57,
    segments: [
      // FIX PHÁT ÂM BOTOX: Viết rõ "botox injections" để AI đọc liền mạch /ˈboʊ.tɑːks/
      { text: "My skin looks like this because I spend fifteen thousand dollars a month on cosmetic surgery, botox treatments, and weekly laser treatments, so please stop wasting your hard-earned paycheck on this garbage.", voice: "af_heart", speed: 1.05 }
    ]
  },
  {
    lineNum: 58,
  ...
  },
  {
    ...
    segments: [
      ...
      { text: "Doctor, is this injection going to hurt?", voice: "am_michael", speed: 1.0 } // Bệnh nhân thanh niên
    ]
  },
  {
    lineNum: 62,
  ...
  },
  {
    ...
    segments: [
      ...
      { text: "Can you give me this exact haircut? Will it suit my face?", voice: "am_michael", speed: 1.0 }
    ]
  },
  {
    lineNum: 69,
  ...
  },
  {
    ...
    segments: [
      ...
      { text: "I despise you, I loathe this barbershop, and I want to smash this mirror into a million pieces.", voice: "am_michael", speed: 1.1 }
    ]
  },
  ...
  },
  {
    ...
    segments: [
      ...
      { text: "So, do I look like the pictures on my dating profile?", voice: "af_heart", speed: 1.05 } // Gái trẻ Hinge 25 tuổi af_heart
    ]
  },
  {
    lineNum: 77,
  ...
  },
  {
    lineNum: 78,
    segments: [
      { text: "You're wearing so many layers of foundation that if you laugh too hard, an entire slab of makeup is going to fall directly onto your steak.", voice: "am_michael", speed: 1.12 } // Trai Hinge trẻ am_michael
    ]
  },
  {
    lineNum: 79,
    segments: [
      ...
      // FIX ĐỔI GIỌNG: Trai Hinge am_michael hỏi ngược lại
  ...
  },
  {
    lineNum: 80,
    segments: [
      { text: "The girl fires back without missing a single beat: You clearly used heavy filters and angle tricks because in real life you're noticeably shorter and your hairline is fighting for its life.", voice: "af_heart", speed: 1.15 } // Gái Hinge af_heart đanh đá
    ]
  },
  {
    lineNum: 81,
    segments: [
      { text: "And let's be honest: you only brought me to this fancy restaurant because you had a fifty percent off Groupon coupon on your phone, right?", voice: "af_heart", speed: 1.15 }
    ]
  },
  {
    lineNum: 82,
  ...
  },
  {
    lineNum: 84,
    segments: [
      { text: "This looks like a cheap, tarnished piece of junk bought on clearance from Wish or the back shelf of T-J Maxx!", voice: "af_bella", speed: 1.15 } // Bạn gái af_bella chua ngoa
    ]
  },
  {
    lineNum: 85,
    segments: [
      { text: "I've been politely faking my admiration for your terrible taste and cheapness for three entire years—next time just send me cash on Venmo!", voice: "af_bella", speed: 1.15 }
    ]
  },
  {
    lineNum: 86,
  ...
  },
  {
    ...
    segments: [
      ...
      { text: "Yes! You've noticeably gained weight, your double chin is swallowing your neck, and that dress looks like the side seams are about to explode into confetti!", voice: "am_eric", speed: 1.12 } // Người chồng đứng tuổi am_eric
    ]
  },
  {
    lineNum: 88,
  ...
  },
  {
    ...
    segments: [
      ...
      { text: "I only hang out with you because you always pick up the bar tab.", voice: "am_michael", speed: 0.95 }
    ]
  },
  {
    lineNum: 95,
  ...
  // 099 - 110: Scene 10 - Cứu rỗi, Sáng hôm sau & CTA
  {
    ...
    segments: [
      ...
      { text: "Mom, I'm so sorry, your pancakes this morning were genuinely the best in the world!", voice: "am_michael", speed: 1.0 }
    ]
  },
  {
    lineNum: 100,
...
// Danh sách các câu cần RENDER LẠI CHÍNH XÁC (các câu có thay đổi độ tuổi, phát âm hoặc đổi giọng)
export async function runMasterRefinement() {
  console.log("=== BẮT ĐẦU TINH CHỈNH VÀ RENDER LẠI CÁC CÂU THEO GÓP Ý CHUYÊN SÂU ===");
  const outputDir = path.join(__dirname, "output", "script_no_white_lies_us", "raw_voice");
  if (!fs.existsSync(outputDir)) {
    fs.mkdirSync(outputDir, { recursive: true });
  }

  // Danh sách các câu cần render lại (có đổi voice nhân vật theo tuổi hoặc sửa lỗi phát âm)
  const linesToReRender = [
    2, 5, 11, 12, 14, 18, 22, 24, 29, 36, 38, 39, 41, 44, 46, 52, 57, 61, 68, 73, 76, 78, 79, 80, 81, 84, 85, 87, 94, 99
  ];

  console.log(`Số câu cần tái tạo tối ưu: ${linesToReRender.length} câu.`);

  for (let i = 0; i < MASTER_PERFECT_PLAN.length; i++) {
    const plan = MASTER_PERFECT_PLAN[i];
    const fileNum = String(plan.lineNum).padStart(3, "0");
    const fileName = `line_${fileNum}.wav`;
    const targetPath = path.join(outputDir, fileName);

    if (!linesToReRender.includes(plan.lineNum) && fs.existsSync(targetPath)) {
      console.log(`[Line ${fileNum}] ⏭️ Giữ nguyên audio chuẩn.`);
      continue;
    }

    console.log(`\n[Line ${fileNum}] 🔄 Đang render lại ${fileName} (Số phân đoạn: ${plan.segments.length})...`);
    ...
    console.log(`  ✅ Đã xuất hoàn hảo: ${fileName} (${(finalLineWav.length / 1024).toFixed(1)} KB)`);
  }

  console.log("\n=== TẤT CẢ CÁC CÂU ĐÃ ĐƯỢC TINH CHỈNH HOÀN HẢO! ===");
...
if (process.argv[1] && process.argv[1].includes("produce-master-refinement.js")) {
  runMasterRefinement().catch(console.error);
}
